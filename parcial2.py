...
# Inicialización de los diferents meenús
class MenuPrincipal:
    def __init__(self):
        self.menu_personas = MenuPersonas()
    ...
    def submenu_personas(self):
        while True:
            ...
            if opcion == "1":
                ...
                print("Opción no válida. Por favor, seleccione una opción válida.")
# Mostrar submenu de unversidades y manejar las opciones seleccionadas
...
# Mostrar submenu de notas y manejar las opciones seleccinandas
...
# Mostrar submenu de asignatura y manejar las opciones seleccionadas
